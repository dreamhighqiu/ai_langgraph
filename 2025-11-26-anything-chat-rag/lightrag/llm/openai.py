...
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YzNOYWJ3PT06NmJlYWRjZWY=
...
def create_openai_async_client(
    ...
    if use_azure:
        ...
        if client_configs is None:
            client_configs = {}
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YzNOYWJ3PT06NmJlYWRjZWY=
...
# pylint: disable  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YzNOYWJ3PT06NmJlYWRjZWY=
                    ...
                    if enable_cot:
                        ...
                        if content:
                            if r"\u" in content:
                                content = safe_unicode_decode(content.encode("utf-8"))
                            yield content
# pragma: no cover  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YzNOYWJ3PT06NmJlYWRjZWY=
