...
-- ========== 第二部分：性能测试/UI自动化/API自动化（3000-3299）==========
-- 1) 清空测试相关菜单与角色绑定
...
-- UI 自动化
(3100,'UI自动化',0,2,'ui-automation',NULL,NULL,1,0,'M','0','0',NULL,'monitor','admin',NOW(),'admin',NOW(),'UI 自动化根目录'),
(3101,'需求管理',3100,1,'requirement','testing/ui-automation/requirement',NULL,1,0,'C','0','0','testing:requirement:list','list','admin',NOW(),'admin',NOW(),'UI自动化需求管理'),
(3102,'脚本管理',3100,2,'script','testing/ui-automation/script',NULL,1,0,'C','0','0','testing:script:list','edit','admin',NOW(),'admin',NOW(),'UI自动化脚本管理'),
(3103,'脚本执行',3100,3,'execution','testing/ui-automation/execution',NULL,1,0,'C','0','0','testing:execution:list','play','admin',NOW(),'admin',NOW(),'UI自动化脚本执行'),
(3104,'报告管理',3100,4,'report','testing/ui-automation/report',NULL,1,0,'C','0','0','testing:report:list','document','admin',NOW(),'admin',NOW(),'UI自动化报告管理'),

-- API 自动化
(3200,'API自动化',0,3,'api-automation',NULL,NULL,1,0,'M','0','0',NULL,'api','admin',NOW(),'admin',NOW(),'API 自动化根目录'),
...
-- UI 按钮 3111-3143（同权限标识）
(3111,'需求查询',3101,1,'','',NULL,1,0,'F','0','0','testing:requirement:query',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3112,'需求新增',3101,2,'','',NULL,1,0,'F','0','0','testing:requirement:add',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3113,'需求修改',3101,3,'','',NULL,1,0,'F','0','0','testing:requirement:edit',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3114,'需求删除',3101,4,'','',NULL,1,0,'F','0','0','testing:requirement:remove',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3115,'AI生成脚本',3101,5,'','',NULL,1,0,'F','0','0','testing:requirement:generate',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3116,'AI需求分析',3101,6,'','',NULL,1,0,'F','0','0','testing:requirement:analyze',NULL,'admin',NOW(),'admin',NOW(),NULL),

(3121,'脚本查询',3102,1,'','',NULL,1,0,'F','0','0','testing:script:query',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3122,'脚本新增',3102,2,'','',NULL,1,0,'F','0','0','testing:script:add',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3123,'脚本修改',3102,3,'','',NULL,1,0,'F','0','0','testing:script:edit',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3124,'脚本删除',3102,4,'','',NULL,1,0,'F','0','0','testing:script:remove',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3125,'脚本执行',3102,5,'','',NULL,1,0,'F','0','0','testing:script:execute',NULL,'admin',NOW(),'admin',NOW(),NULL),

(3131,'执行查询',3103,1,'','',NULL,1,0,'F','0','0','testing:execution:query',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3132,'取消执行',3103,2,'','',NULL,1,0,'F','0','0','testing:execution:cancel',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3133,'重试执行',3103,3,'','',NULL,1,0,'F','0','0','testing:execution:retry',NULL,'admin',NOW(),'admin',NOW(),NULL),

(3141,'报告查询',3104,1,'','',NULL,1,0,'F','0','0','testing:report:query',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3142,'报告下载',3104,2,'','',NULL,1,0,'F','0','0','testing:report:download',NULL,'admin',NOW(),'admin',NOW(),NULL),
(3143,'报告删除',3104,3,'','',NULL,1,0,'F','0','0','testing:report:remove',NULL,'admin',NOW(),'admin',NOW(),NULL),
