  ...
  <div class="app-container">
    <el-card class="header-card">
      <div class="header-content">
        <div>
          <h2><el-icon><Link /></el-icon> API自动化测试需求</h2>
          <p class="subtitle">REST API Automation Requirements</p>
        </div>
...
<script setup name="APIAutomationRequirement">
...
function handleGenerate(row) {
  ElMessage.info('AI生成REST API测试脚本')
}
