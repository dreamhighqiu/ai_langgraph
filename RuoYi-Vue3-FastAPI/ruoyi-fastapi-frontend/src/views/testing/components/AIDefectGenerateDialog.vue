  ...
  >
    ...
    <div class="dialog-header">
      ...
      <div class="header-text">
        <h3>从文档/图片生成缺陷分析</h3>
        <p>上传缺陷截图、错误日志或缺陷报告，AI 将自动分析内容并生成结构化的缺陷分析报告</p>
      </div>
    </div>
    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="启用 RAG 检索">
        ...
        <div class="form-tip" style="margin-top: 8px">
          ...
          启用后，AI 会先从知识库检索相似的历史缺陷和解决方案，然后结合文档内容生成更准确的缺陷分析。
        </div>
      </el-form-item>
    </el-form>
...
import { Warning, Document, CircleCheck, UploadFilled, InfoFilled } from '@element-plus/icons-vue'
...
请先使用 parse_document_from_url 工具解析文档内容，提取关键缺陷信息和错误描述。${form.useRag ? '然后使用 rag_query_tool 从知识库检索相似的历史缺陷和解决方案，结合文档内容和检索结果生成完整的缺陷分析报告。' : '然后基于解析的文档内容生成完整的缺陷分析报告。'}`
