  ...
  >
    ...
    <div class="dialog-header">
      ...
      <div class="header-text">
        <h3>从文档/图片生成测试用例</h3>
        <p>上传需求文档、规格说明或界面截图，AI 将自动分析内容并生成相应的测试用例</p>
      </div>
    </div>
    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="用例模板" prop="template">
    ...
    <template #footer>
      ...
      >
        <el-icon v-if="!uploading && !generating"><MagicStick /></el-icon>
        {{ uploading ? '上传中...' : generating ? 'AI 分析中...' : '生成测试用例' }}
      </el-button>
    </template>
  </el-dialog>
</template>
