...
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2pGMWNnPT06NTZlOWRiYmI=
...
async def upload_test_case_attachment(
    ...
    await db.commit()
    return SuccessResponse(success=True, data=result)
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2pGMWNnPT06NTZlOWRiYmI=
...
# fmt: off  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2pGMWNnPT06NTZlOWRiYmI=
...
async def get_attachment_download_url(
    ...
    return SuccessResponse(success=True, data=result)
# noqa  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2pGMWNnPT06NTZlOWRiYmI=
