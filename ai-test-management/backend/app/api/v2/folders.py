...
# fmt: off  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VGtSemJBPT06OTExMjdhZjk=
...
async def get_folders(
    ...
    folders, total = await service.get_root_folders(
        project_identifier, offset, pagination.page_size
    )
...
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VGtSemJBPT06OTExMjdhZjk=
...
async def get_sub_folders(
    ...
    folders, total = await service.get_sub_folders(
        project_identifier, folder_id, offset, pagination.page_size
    )
# fmt: off  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VGtSemJBPT06OTExMjdhZjk=
    
    total_pages = (total + pagination.page_size - 1) // pagination.page_size
    base_url = f"{settings.api_prefix}/projects/{project_identifier}/folders/{folder_id}/sub-folders"
    
    prev_url = f"{base_url}?p={pagination.page - 1}&page_size={pagination.page_size}" if pagination.page > 1 else None
    next_url = f"{base_url}?p={pagination.page + 1}&page_size={pagination.page_size}" if pagination.page < total_pages else None
...
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VGtSemJBPT06OTExMjdhZjk=
