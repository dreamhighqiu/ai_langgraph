...
# fmt: off  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2tGclR3PT06MDIwMjUwZjk=
...
class ConfigurationRepository:
    ...
    async def get_by_name(self, name: str) -> Optional[Configuration]:
        ...
        result = await self.session.execute(stmt)
        return result.scalar_one_or_none()
# noqa  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2tGclR3PT06MDIwMjUwZjk=
...
# pylint: disable  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2tGclR3PT06MDIwMjUwZjk=
    ...
    async def delete(self, configuration: Configuration) -> None:
        ...
        await self.session.flush()
# type: ignore  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2tGclR3PT06MDIwMjUwZjk=
