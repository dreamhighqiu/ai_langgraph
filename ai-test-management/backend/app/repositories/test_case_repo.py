...
# pylint: disable  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TTJKcmF3PT06MmYxZmUxODk=
...
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TTJKcmF3PT06MmYxZmUxODk=
    ...
    async def count_by_project_with_filters(
        ...
        if statuses:
            query = query.where(TestCase.state.in_(statuses))
# type: ignore  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TTJKcmF3PT06MmYxZmUxODk=
    ...
    async def get_next_sequence(self, project_id: UUID) -> int:
        ...
        return count + 1
# pragma: no cover  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TTJKcmF3PT06MmYxZmUxODk=
