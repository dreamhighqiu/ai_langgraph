...
# type: ignore  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2ZUU0NFVRPT06M2JmNDdhNjc=
...
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2ZUU0NFVRPT06M2JmNDdhNjc=
        
        return [self._to_info(c) for c in configs], total
# type: ignore  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2ZUU0NFVRPT06M2JmNDdhNjc=
    ...
    async def delete(self, config_id: int) -> None:
        ...
        if not config:
            raise NotFoundException(resource_type="配置", resource_id=str(config_id))
# type: ignore  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2ZUU0NFVRPT06M2JmNDdhNjc=
