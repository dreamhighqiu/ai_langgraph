...
# pylint: disable  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TUZoeFZnPT06M2Q4Y2E0YzY=
...
class ExportService:
    ...
    async def _process_export(self, export_id: str) -> None:
        ...
        try:
            ...
            if not job:
                return
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TUZoeFZnPT06M2Q4Y2E0YzY=
    ...
    async def _generate_feature_content(self, job: dict) -> str:
        ...
        # 这里生成示例内容
        lines = []
# noqa  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TUZoeFZnPT06M2Q4Y2E0YzY=
...
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TUZoeFZnPT06M2Q4Y2E0YzY=
