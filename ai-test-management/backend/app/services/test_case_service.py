...
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UVZWV1lnPT06MTE0ZjQ3ODU=
    ...
    async def create_test_case(
        ...
        return await self._test_case_to_info(tc, project_identifier)
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UVZWV1lnPT06MTE0ZjQ3ODU=
    ...
    async def bulk_update_test_cases(
        ...
        """批量更新测试用例（简单批量更新）"""
        project = await self._get_project_by_identifier(project_identifier)
# fmt: off  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UVZWV1lnPT06MTE0ZjQ3ODU=
    ...
    async def get_test_case_history(
        ...
        """获取测试用例历史记录"""
        project = await self._get_project_by_identifier(project_identifier)
# pylint: disable  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UVZWV1lnPT06MTE0ZjQ3ODU=
