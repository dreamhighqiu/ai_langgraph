...
# fmt: off  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WXpOS1VBPT06NzY2OWVjMTk=
...
class TestPlanService:
    ...
    async def create_test_plan(
        ...
        while await self.repo.identifier_exists(identifier):
            sequence += 1
            identifier = generate_test_plan_identifier(sequence)
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WXpOS1VBPT06NzY2OWVjMTk=
    ...
    async def update_test_plan(
        ...
        return await self._build_test_plan_info(test_plan, project_identifier)
# noqa  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WXpOS1VBPT06NzY2OWVjMTk=
...
# type: ignore  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WXpOS1VBPT06NzY2OWVjMTk=
