...
class TestResultService:
    ...
    async def _to_info(self, result: TestResult, test_run_identifier: str) -> TestResultInfo:
        """将模型转换为响应信息"""
        tc = result.test_case
# fmt: off  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2U0hjeVdRPT06MmFlZDYxNzg=
...
# pylint: disable  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2U0hjeVdRPT06MmFlZDYxNzg=
    ...
    async def _add_single_result(
        ...
        return await self._to_info(result, test_run_identifier)
# type: ignore  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2U0hjeVdRPT06MmFlZDYxNzg=
...
# pylint: disable  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2U0hjeVdRPT06MmFlZDYxNzg=
