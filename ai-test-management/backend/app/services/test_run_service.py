...
# fmt: off  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YVV0ck1RPT06YTE1NzJmN2E=
...
# pragma: no cover  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YVV0ck1RPT06YTE1NzJmN2E=
    ...
    async def get_test_cases(
        ...
        """获取测试运行中的测试用例列表"""
        project = await self._get_project_by_identifier(project_identifier)
# noqa  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YVV0ck1RPT06YTE1NzJmN2E=
    ...
    async def update_assignees(
        ...
        return await self._to_info(test_run, project_identifier)
# type: ignore  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YVV0ck1RPT06YTE1NzJmN2E=
