...
// TODO  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Ym5CMlZRPT06YjM4YzI1OTg=
...
// NOTE  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Ym5CMlZRPT06YjM4YzI1OTg=
...
// NOTE  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Ym5CMlZRPT06YjM4YzI1OTg=
...
export function AIChatDialog({
  ...
  }, [projectId, folderId, templateType]); // 当参数变化时重新初始化
    ...
    <Drawer open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex items-center justify-between border-b px-6 py-4 bg-background">
          <h2 className="text-lg font-semibold">生成测试用例 - AI 助手</h2>
...
// NOTE  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Ym5CMlZRPT06YjM4YzI1OTg=
