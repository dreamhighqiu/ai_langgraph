            ...
            for k, v in self._data.items():
                if v["status"] == status.value:
                    try:
                        ...
                        continue
        return result
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T0hGblVRPT06MjU3OTJmYzI=
...
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T0hGblVRPT06MjU3OTJmYzI=
        ...
        async with self._storage_lock:
            for doc_id, doc_data in self._data.items():
                ...
                if (
                    ...
                    continue
# fmt: off  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T0hGblVRPT06MjU3OTJmYzI=
        ...
        async with self._storage_lock:
            ...
            for doc_id in doc_ids:
                ...
                if result is not None:
                    any_deleted = True
# noqa  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T0hGblVRPT06MjU3OTJmYzI=
