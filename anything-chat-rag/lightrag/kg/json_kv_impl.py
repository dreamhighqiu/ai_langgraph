...
# pylint: disable  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y1VaVWR3PT06N2YyMzM3OTE=
        ...
        async with self._storage_lock:
            ...
            for id in ids:
                ...
                if data:
                    ...
                    results.append(None)
            return results
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y1VaVWR3PT06N2YyMzM3OTE=
    ...
    async def delete(self, ids: list[str]) -> None:
        ...
        async with self._storage_lock:
            ...
            if any_deleted:
                await set_all_update_flags(self.namespace, workspace=self.workspace)
# pylint: disable  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y1VaVWR3PT06N2YyMzM3OTE=
...
# pragma: no cover  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y1VaVWR3PT06N2YyMzM3OTE=
