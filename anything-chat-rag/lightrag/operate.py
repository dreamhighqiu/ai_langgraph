...
async def _handle_entity_relation_summary(
    ...
    if not description_list:
        return "", False
# type: ignore  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YkdJMGNBPT06NTUwZDIyOTQ=
    ...
    while True:
        ...
        if current_chunk:
            chunks.append(current_chunk)
# pragma: no cover  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YkdJMGNBPT06NTUwZDIyOTQ=
...
async def _handle_single_entity_extraction(
    ...
    if len(record_attributes) != 4 or "entity" not in record_attributes[0]:
        ...
        return None
# pylint: disable  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YkdJMGNBPT06NTUwZDIyOTQ=
...
# pragma: no cover  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2YkdJMGNBPT06NTUwZDIyOTQ=
