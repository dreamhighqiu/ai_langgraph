...
async def check_lightrag_setup(rag_instance: LightRAG, verbose: bool = False) -> bool:
    ...
    issues = []
    warnings = []
# pylint: disable  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TjI5elp3PT06ZDZmOGQ0ZDQ=
...
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TjI5elp3PT06ZDZmOGQ0ZDQ=
    ...
    if issues:
        ...
        if warnings and verbose:
            ...
            for warning in warnings:
                print(f"  • {warning}")
# noqa  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TjI5elp3PT06ZDZmOGQ0ZDQ=
...
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TjI5elp3PT06ZDZmOGQ0ZDQ=
