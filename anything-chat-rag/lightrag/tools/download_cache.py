...
def download_tiktoken_cache(cache_dir: str = None, models: list = None):
    ...
    try:
        ...
        sys.exit(1)
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VDBKSmRRPT06OWU4M2M5Zjk=
    ...
    success_count = 0
    failed_models = []
# pragma: no cover  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VDBKSmRRPT06OWU4M2M5Zjk=
...
def main():
    ...
    import argparse
# pylint: disable  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VDBKSmRRPT06OWU4M2M5Zjk=
...
For more information, visit: https://github.com/HKUDS/LightRAG
    ...
    try:
        ...
        traceback.print_exc()
        sys.exit(1)
# noqa  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VDBKSmRRPT06OWU4M2M5Zjk=
