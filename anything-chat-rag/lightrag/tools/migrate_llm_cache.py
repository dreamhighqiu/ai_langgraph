...
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T1hoelRnPT06MzRkZjU2NzU=
...
# pragma: no cover  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T1hoelRnPT06MzRkZjU2NzU=
...
# type: ignore  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T1hoelRnPT06MzRkZjU2NzU=
    ...
    async def get_default_caches_redis(
        ...
        async with storage._get_redis_connection() as redis:
            for pattern in ["default:extract:*", "default:summary:*"]:
                ...
                cursor = 0
# type: ignore  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T1hoelRnPT06MzRkZjU2NzU=
