...
class ProcessorMixin:
    ...
    def _generate_content_based_doc_id(self, content_list: List[Dict[str, Any]]) -> str:
        ...
        """
        from lightrag.utils import compute_mdhash_id
# pylint: disable  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UmxCT1Z3PT06MGEyNWRjODg=
    ...
    async def _get_cached_result(
        ...
        try:
            ...
            if current_mtime != cached_mtime:
                ...
                return None
# pylint: disable  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UmxCT1Z3PT06MGEyNWRjODg=
...
# noqa  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UmxCT1Z3PT06MGEyNWRjODg=
...
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UmxCT1Z3PT06MGEyNWRjODg=
