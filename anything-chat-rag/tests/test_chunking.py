    ...
    def decode(self, tokens):
        ...
        while i < len(tokens):
            ...
            if (
                ...
                i += 1
        return "".join(result)
# pragma: no cover  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T1VKUVZRPT06MjE4MGRiMjA=
...
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T1VKUVZRPT06MjE4MGRiMjA=
...
def test_split_with_chunk_overlap():
    ...
    assert len(chunks) == 4
# pylint: disable  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T1VKUVZRPT06MjE4MGRiMjA=
...
# type: ignore  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2T1VKUVZRPT06MjE4MGRiMjA=
