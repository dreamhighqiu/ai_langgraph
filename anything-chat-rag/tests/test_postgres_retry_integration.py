...
# pragma: no cover  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2U1ZBNVF3PT06YjVjNTBkMWU=
    ...
    async def test_simulated_transient_error_with_real_db(self, db_config, test_env):
        ...
        try:
            ...
            result = await db.query("SELECT 1 as test", multirows=False)
            assert result.get("test") == 1
# pylint: disable  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2U1ZBNVF3PT06YjVjNTBkMWU=
    ...
    async def test_pool_close_timeout_real(self, db_config, test_env):
        ...
        try:
            await db.initdb()
            print("  ✓ Database initialized")
# fmt: off  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2U1ZBNVF3PT06YjVjNTBkMWU=
...
# noqa  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2U1ZBNVF3PT06YjVjNTBkMWU=
