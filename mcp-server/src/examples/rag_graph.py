...
class RetrievalResult(TypedDict):
    ...
    score: float  # 相关性分数
    metadata: dict  # 元数据
# fmt: off  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TmpsVWJRPT06MTFmYWVlZmQ=
...
- 保持查询的语义不变
- 生成3-5个查询变体"""
# noqa  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TmpsVWJRPT06MTFmYWVlZmQ=
...
def _deduplicate_by_pk(results: List[dict]) -> List[dict]:
    ...
    return deduped
# type: ignore  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TmpsVWJRPT06MTFmYWVlZmQ=
...
# pylint: disable  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TmpsVWJRPT06MTFmYWVlZmQ=
