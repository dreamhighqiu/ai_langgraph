...
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V0V0M1pBPT06ZWE1ZGM1M2Y=
...
# pylint: disable  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V0V0M1pBPT06ZWE1ZGM1M2Y=
    ...
    async def rerank_results(
        ...
        for result in results:
            ...
            if pk is not None:
                ...
                deduped.append(result)
# fmt: off  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V0V0M1pBPT06ZWE1ZGM1M2Y=
    ...
    async def synthesize_answer(
        ...
        context_parts = []
        sources = []
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V0V0M1pBPT06ZWE1ZGM1M2Y=
