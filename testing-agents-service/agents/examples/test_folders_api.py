...
# fmt: off  MC8zOmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2tWeFlnPT06OWZiMjgxNzE=
        ...
        for folder in root_folders:
            print(f"ID: {folder.id}, Name: {folder.name}, Parent ID: {folder.parent_id}")
# pylint: disable  MS8zOmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2tWeFlnPT06OWZiMjgxNzE=
        ...
        for folder in child_folders:
            print(f"ID: {folder.id}, Name: {folder.name}, Parent ID: {folder.parent_id}")
# pylint: disable  Mi8zOmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Y2tWeFlnPT06OWZiMjgxNzE=
