...
// eslint-disable  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Unpkc2FBPT06ZTAyZWU2M2U=
...
// NOTE  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Unpkc2FBPT06ZTAyZWU2M2U=
    ...
    async startConsoleMonitoring(client, browserId, realTime = false) {
        ...
        const consoleListener = (params) => {
            ...
            if (realTime) {
                console.error(`[Console:${browserId}] ${message.level.toUpperCase()}: ${message.text}`);
            }
        };
        ...
        const exceptionListener = (params) => {
            ...
            if (realTime) {
                console.error(`[Console:${browserId}] ERROR: ${message.text}`);
            }
        };
...
// eslint-disable  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Unpkc2FBPT06ZTAyZWU2M2U=
...
// @ts-expect-error  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2Unpkc2FBPT06ZTAyZWU2M2U=
