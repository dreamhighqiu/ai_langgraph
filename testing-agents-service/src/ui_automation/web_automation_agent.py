...
# pylint: disable  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UkVoM1JRPT06OWE0YzljZGE=
...
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UkVoM1JRPT06OWE0YzljZGE=
...
def create_ui_automation_agent(
    ...
    # 设置 API key 环境变量
    if config.api_key and not os.environ.get("DEEPSEEK_API_KEY"):
    ...
    if enable_chart_tools:
        try:
            ...
            print(f"[警告] 无法加载图表工具: {e}")
# fmt: off  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UkVoM1JRPT06OWE0YzljZGE=
...
# pragma: no cover  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2UkVoM1JRPT06OWE0YzljZGE=
