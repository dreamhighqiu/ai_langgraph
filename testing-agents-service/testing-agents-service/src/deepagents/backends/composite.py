...
# pylint: disable  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WWtsQ1Z3PT06ZGRiYTVkYzk=
...
class CompositeBackend:
    ...
    async def agrep_raw(
        ...
        return all_matches
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WWtsQ1Z3PT06ZGRiYTVkYzk=
...
# pylint: disable  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WWtsQ1Z3PT06ZGRiYTVkYzk=
    ...
    async def aupload_files(self, files: list[tuple[str, bytes]]) -> list[FileUploadResponse]:
        ...
        for backend, batch in backend_batches.items():
            ...
            indices, stripped_paths, contents = zip(*batch, strict=False)
            batch_files = list(zip(stripped_paths, contents, strict=False))
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WWtsQ1Z3PT06ZGRiYTVkYzk=
