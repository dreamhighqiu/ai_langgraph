...
with open(file_path, 'w') as f:
    f.write(content)
" 2>&1"""
# fmt: off  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2ZFZaNlVRPT06OTVjZWE0NDg=
...
" 2>/dev/null"""
    ...
    def read(
        ...
        result = self.execute(cmd)
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2ZFZaNlVRPT06OTVjZWE0NDg=
    ...
    def edit(
        ...
        result = self.execute(cmd)
# type: ignore  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2ZFZaNlVRPT06OTVjZWE0NDg=
    ...
    def glob_info(self, pattern: str, path: str = "/") -> list[FileInfo]:
        ...
        result = self.execute(cmd)
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2ZFZaNlVRPT06OTVjZWE0NDg=
