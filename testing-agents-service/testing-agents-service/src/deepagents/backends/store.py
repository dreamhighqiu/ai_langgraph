...
# pragma: no cover  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V2s1S1dBPT06MGU2YmQ5MzI=
    ...
    def ls_info(self, path: str) -> list[FileInfo]:
        ...
        for item in items:
            ...
            if not str(item.key).startswith(normalized_path):
                continue
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V2s1S1dBPT06MGU2YmQ5MzI=
    ...
    def edit(
        ...
        store = self._get_store()
        namespace = self._get_namespace()
# fmt: off  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V2s1S1dBPT06MGU2YmQ5MzI=
    ...
    def upload_files(self, files: list[tuple[str, bytes]]) -> list[FileUploadResponse]:
        ...
        return responses
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V2s1S1dBPT06MGU2YmQ5MzI=
