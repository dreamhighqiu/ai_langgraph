...
# type: ignore  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WlhKdVNnPT06NjhiYmM4ZmM=
...
def _validate_path(path: str, *, allowed_prefixes: Sequence[str] | None = None) -> str:
    ...
    if allowed_prefixes is not None and not any(normalized.startswith(prefix) for prefix in allowed_prefixes):
        ...
        raise ValueError(msg)
# pylint: disable  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WlhKdVNnPT06NjhiYmM4ZmM=
...
# pragma: no cover  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WlhKdVNnPT06NjhiYmM4ZmM=
...
# pylint: disable  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2WlhKdVNnPT06NjhiYmM4ZmM=
