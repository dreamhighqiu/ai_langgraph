...
# pragma: no cover  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VWxkYVdBPT06ZTU2NjVjMjc=
...
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VWxkYVdBPT06ZTU2NjVjMjc=
...
""").strip()
    ...
    # 知识库配置
    KNOWLEDGE_API_URL: str = os.getenv("KNOWLEDGE_API_URL", "http://localhost:9621")
...
# noqa  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VWxkYVdBPT06ZTU2NjVjMjc=

        for key in sensitive_keys:
            if key in config and config[key]:
                config[key] = "***" + config[key][-4:] if len(config[key]) > 4 else "***"
# pylint: disable  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VWxkYVdBPT06ZTU2NjVjMjc=
