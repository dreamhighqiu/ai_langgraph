...
class K6Config:
    ...
    """
    binary_path: str = "k6"
    scripts_dir: Path = field(default_factory=lambda: Path("./k6_scripts"))
    results_dir: Path = field(default_factory=lambda: Path("./k6_results"))
    default_vus: int = 10
...
# type: ignore  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VjBzMFpBPT06ZGNiYzI2OWU=
...
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VjBzMFpBPT06ZGNiYzI2OWU=
...
class ReportConfig:
    ...
    """
    reports_dir: Path = field(default_factory=lambda: Path("./k6_reports"))
    charts_dir: Path = field(default_factory=lambda: Path("./k6_charts"))
...
# pragma: no cover  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VjBzMFpBPT06ZGNiYzI2OWU=
...
# type: ignore  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2VjBzMFpBPT06ZGNiYzI2OWU=
