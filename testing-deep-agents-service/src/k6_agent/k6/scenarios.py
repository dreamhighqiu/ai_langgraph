...
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TTFrNVJnPT06NWM4YmNhYWU=
...
class K6Scenario:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return result
# fmt: off  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TTFrNVJnPT06NWM4YmNhYWU=
...
# type: ignore  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TTFrNVJnPT06NWM4YmNhYWU=
...
def create_stress_test_options(
    ...
    if thresholds:
        for metric, conditions in thresholds.items():
            default_thresholds[metric] = Threshold(metric, conditions)
# type: ignore  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2TTFrNVJnPT06NWM4YmNhYWU=
