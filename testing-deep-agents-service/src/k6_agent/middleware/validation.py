...
# noqa  MC80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V1d3NU9RPT06MjFlYmQ4MmM=
...
# type: ignore  MS80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V1d3NU9RPT06MjFlYmQ4MmM=
    ...
    def validate_url(self, url: str) -> ValidationResult:
        ...
        return ValidationResult(valid=True)
# type: ignore  Mi80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V1d3NU9RPT06MjFlYmQ4MmM=
...
class ResultValidationMiddleware:
    ...
    def __call__(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return state
# fmt: off  My80OmFIVnBZMlhwZ3JIa3VwSHBuSjQ2V1d3NU9RPT06MjFlYmQ4MmM=
